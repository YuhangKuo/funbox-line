...
> 當來源出現目前 RULES.md 尚未指定的新商品，且使用者明確要求新增追蹤商品時，先依來源確認商品的型號代碼與正規化後完整商品名稱，再將商品新增至 RULES.md 的指定追蹤商品清單；**RULES.md 新增完成後，必須立即同步核對並更新 INDEX**：若該商品目前在固定 5 地區有可確認的販售／抽選資料，就加入 INDEX；若確認沒有固定 5 地區資料，就維持不加入 INDEX，但仍保留在 RULES.md。未經使用者明確要求，不因來源出現新商品而自行新增。
...
- 若使用者明確要求新增商品，RULES.md 新增後必須同步處理 INDEX，不得只更新 RULES.md 而結束。
- 新增商品進 INDEX 前，必須先確認其在固定 5 地區是否有可確認的販售／抽選資料；有資料才加入，沒有資料則保留在 RULES.md、不加入 INDEX。
